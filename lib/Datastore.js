...
class Datastore {
    ...
    dsCreateLight(clientid, name, type, model) {
        ...
        const id = this.dsGetNewLightId(clientid);
    ...
    dsCreateSensor(typ, clientid, name) {
        if (typeof clientid === 'string' && Object.prototype.hasOwnProperty.call(this.dsSensors.nodelist.nodes, clientid)) {
            // client already exists
        ...
        if (typeof typ !== 'undefined') {
            ...
            if (zll) {
                ...
                const id = this.dsGetNewSensorId(clientid);
        ...
        const id = this.dsGetNewSensorId();
        this.dsSensors.list[id] = s;
        storage.setItemSync('dsSensors', this.dsSensors);
