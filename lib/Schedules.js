...
class Schedules {
     ...
     * Scenes dispatcher.
     *
     * @see https://developers.meethue.com/documentation/schedules-api-0
     *
    ...
    schedulesDispatcher(response, method, url, urlParts, obj) {
        ...
        */
        ...
        const api1 = /^\/api\/(\w+)\/schedules$/.exec(url);
        const api2 = /^\/api\/(\w+)\/schedules\/(\w+)$/.exec(url);
    ...
    schedulesCreate(response, method, url, urlParts, obj) {
        ...
        if (this.dsIsUsernameValid(urlParts[2])) {
            ...
            if (Object.prototype.hasOwnProperty.call(obj,'localtime')) {
                o.localtime = obj.localtime;
            }
            if (Object.prototype.hasOwnProperty.call(obj,'status')) {
                o.status = obj.status;
            }
            if (Object.prototype.hasOwnProperty.call(obj,'autodelete')) {
     ...
     * @return {boolean|{type: string}} Parsed time object or FALSE.
     * @private
     */
